...
if not string.find(identifyexecutor(), 'Solara') or  string.find(identifyexecutor(), 'Xeno v1.1.65') then
...
local PlayaTab = Window:AddTab('Player')
local ExploitTab = Window:AddTab('Exploits')
local ShoppingTab = Window:AddTab('Shopping')
local Tabs = {
    ['UI Settings'] = Window:AddTab('UI Settings'),
}

local Aimbot = AimbotTab:AddLeftGroupbox('Aiming')
